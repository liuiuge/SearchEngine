...
OLWebpage::OLWebpage(string & doc,My_conf & conf, Word_segment & jieba)
    :_doc(doc)
{
    _topword.reserve(10);
...
void OLWebpage::processDoc(const string & doc, My_conf & conf,Word_segment & jieba)
{
...
void OLWebpage::calcTopk(vector<string> & wordsVec, int k, set<string> & stopwordlist)
{
